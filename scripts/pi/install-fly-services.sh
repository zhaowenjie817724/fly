...
for svc in wurenji-acq wurenji-api wurenji-fsm wurenji-infer wurenji-thermal wurenji-doa wurenji-watchdog; do
...
echo "启用服务..."
ENABLE_LIST="wurenji-acq wurenji-api wurenji-fsm wurenji-infer wurenji-thermal wurenji-doa wurenji-watchdog"
